...
int main(int argc,char *argv[])
{
	...
	lutm topic_model(vocab_size, num_classes, queries, num_threads, delta, null_tag, seed);
	...
	if(train == 0) {
		...
		topic_model.read_dist(file_handle_1);
	...
	if(train == 1){
		...
		topic_model.write_dist(out_file_handle);
		out_file_handle.close();
	}
